    ...
    <div style={styles.page}>
      <header style={styles.navbar}>
        ...
        <nav style={styles.navLinks}>
          {["Why Use Chatbot?", "Mindfulness", "Stress Tips", "Meditation", "About"].map((item, index) => (
            <a
              key={index}
              href="#"
      ...
      <footer style={styles.footer}>
        <p style={styles.footerText}>Designed by Yashraj Limkar & Zeal Vira</p>
      </footer>
        ...
        <div style={styles.popupOverlay}>
          <div style={styles.popupCard}>
            ...
            <p style={styles.popupText}>
              {activePopup === "About"
                ? "I created the mental health chatbot to help people manage stress, anxiety, and other mental health issues in a simple and easy way. In today’s busy world, many people feel overwhelmed, and I wanted to build a tool that can provide support anytime."
